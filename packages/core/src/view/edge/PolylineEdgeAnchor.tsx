...
import BaseEdgeAnchor from './BaseEdgeAnchor';
...
export default class PolylineEdge extends BaseEdgeAnchor {
  drag;
  isDraging: boolean;
  ...
  onDragStart = () => {
    const polylineModel = this.props.model;
